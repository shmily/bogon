...
#define _CHANNEL			(0x00)
#define PWM_REGISTER_BASE	(0xf1C21400)

#define PWM_CTRL_REG		(PWM_REGISTER_BASE + 0x10*_CHANNEL)
#define PWM_PRD_REG			(PWM_REGISTER_BASE + 0x10*_CHANNEL + 0x04)
...
u32 prescal_table[] = { 1, 2, 4, 8, 16, 32, 64 };
